...
add_action('wp_print_styles', 'neatbds_adminify_remove_dashicons', 100);

/** Remove Dashicons from Admin Bar for non logged in users **/
function neatbds_adminify_remove_dashicons()
{
...
add_action('wp_head', function () {
    echo get_field('analytics', 'option');
});
add_action('wp_body_open', function () {
    echo get_field('analytics_body', 'option');
});
add_action('wp_footer', function () {
    echo get_field('analytics_footer', 'option');
});
